...
public final class ControlClient {
    ...
    public void sendAudioRuntimeTelemetry(
        ...
        int speakerTrackState,
        int speakerTrackSampleRate,
        int speakerTrackPlaybackRate,
        int speakerNativeOutputSampleRate,
        int speakerTrackBufferSizeFrames,
        int speakerMinBufferBytes,
        int speakerPlaybackBufferBytes,
        int speakerUnderrunCount,
        int speakerAudioSessionId,
        int speakerPlaybackRateSetResult,
        long speakerWritePackets,
        long speakerWriteCalls,
        long speakerWriteBytes,
        int speakerLastWriteBytes,
        double speakerLastWriteMs,
        double speakerAverageWriteMs,
        double speakerMaxWriteMs,
        ...
        JSONObject speaker = payload(
            ...
            "trackState", speakerTrackState,
            "trackSampleRate", speakerTrackSampleRate,
            "trackPlaybackRate", speakerTrackPlaybackRate,
            "nativeOutputSampleRate", speakerNativeOutputSampleRate,
            "trackBufferSizeFrames", speakerTrackBufferSizeFrames,
            "minBufferBytes", speakerMinBufferBytes,
            "playbackBufferBytes", speakerPlaybackBufferBytes,
            "underrunCount", speakerUnderrunCount,
            "audioSessionId", speakerAudioSessionId,
            "playbackRateSetResult", speakerPlaybackRateSetResult,
            "writePackets", speakerWritePackets,
            "writeCalls", speakerWriteCalls,
            "writeBytes", speakerWriteBytes,
            "lastWriteBytes", speakerLastWriteBytes,
            "lastWriteMs", speakerLastWriteMs,
            "averageWriteMs", speakerAverageWriteMs,
            "maxWriteMs", speakerMaxWriteMs,
